...
class AlbumSeeMorePage extends StatefulWidget {
  const AlbumSeeMorePage({Key? key}) : super(key: key);

  @override
  State<AlbumSeeMorePage> createState() => _AlbumSeeMorePageState();
}

class _AlbumSeeMorePageState extends State<AlbumSeeMorePage> {
  ...
  void initState() {
    _dashboardController.fetchDashBoardData().then((_) {
      filteredCourses = _dashboardController.dashboardModel.value.album;
    });
    super.initState();
  }

  TextEditingController searchController = TextEditingController();
  List<Album>? filteredCourses;
  ...
  void filterCourses(String query) {
    ...
    if (query.isNotEmpty) {
      filteredList = _dashboardController.dashboardModel.value.album
          ?.where((album) =>
