...
class UpcomingPodcastPage extends StatefulWidget {
  const UpcomingPodcastPage({super.key});

  @override
  State<UpcomingPodcastPage> createState() => _UpcomingPodcastPageState();
}

class _UpcomingPodcastPageState extends State<UpcomingPodcastPage> {
        ...
        child: Scaffold(
          ...
          body: Container(
            ...
            child: Obx(() => Column(
              ...
              children: [
                Expanded(
                  child: _artistPodcastController.podcastListModel.value.upcomingList?.isNotEmpty ?? false
                      ? buildUpcomingList()
  ...
  Widget buildUpcomingList() {
    final newCourses = _artistPodcastController.podcastListModel.value.upcomingList;
