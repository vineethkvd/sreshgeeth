...
class ArtistDrawerWidget extends StatefulWidget {
  const ArtistDrawerWidget({super.key});

  @override
  State<ArtistDrawerWidget> createState() => _ArtistDrawerWidgetState();
}

class _ArtistDrawerWidgetState extends State<ArtistDrawerWidget> {
