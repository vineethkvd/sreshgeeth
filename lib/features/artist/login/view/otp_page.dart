...
class ArtistOtpVerificationPage extends StatefulWidget {
  final String mobile;
  final String password;
  final String otp;
  const ArtistOtpVerificationPage({super.key, required this.mobile, required this.password, required this.otp});

  @override
  State<ArtistOtpVerificationPage> createState() => _ArtistOtpVerificationPageState();
}

class _ArtistOtpVerificationPageState extends State<ArtistOtpVerificationPage> {
  final ArtistLoginController loginController = Get.put(ArtistLoginController());
